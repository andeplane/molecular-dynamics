...
{
private:
    static vector<shared_ptr<AtomType>> atomTypes;
    static bool isInitialized;
    static void initialize();

public:
    static shared_ptr<AtomType> atomTypeFromAtomicNumber(int atomicNumber);
    static shared_ptr<AtomType> atomTypeFromAtomType(AtomTypes atomType);
